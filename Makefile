...
limok: limok-gen limok-plugins
	go build -a -o limo-keds ./cmd/limo-keds/main.go

limok-plugins: limok-example-plugin

limok-example-plugin: plugin/builtin/example/main.go
...
limok-gen: limok-gen-grpc limok-gen-grpc-reverse-proxy limok-gen-grpc-swagger
...
limok-gen-grpc-reverse-proxy: limok-gen-grpc
	cd gen && protoc \
		-I /usr/local/include \
		-I. \
		-I $(GOPATH)/src \
...
limok-gen-grpc-swagger: limok-gen-grpc
	cd gen && protoc \
		-I /usr/local/include \
		-I. \
		-I $(GOPATH)/src \
