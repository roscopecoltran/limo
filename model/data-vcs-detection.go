...
type LanguageDetected struct {
	gorm.Model
	//sorting.SortingDESC
	Name        string `gorm:"column:name" yaml:"name,omitempty" json:"name,omitempty"`
	Type        string `gorm:"column:type" yaml:"type,omitempty" json:"type,omitempty"`
	Group       string `gorm:"column:group" yaml:"group,omitempty" json:"group,omitempty"`
	AceMode     string `gorm:"column:ace_mode" yaml:"ace_mode,omitempty" json:"ace_mode,omitempty"`
	IsPopular   bool   `gorm:"column:is_popular" yaml:"is_popular,omitempty" json:"is_popular,omitempty"`
	IsUnpopular bool   `gorm:"column:is_unpopular" yaml:"is_unpopular,omitempty" json:"is_unpopular,omitempty"`
