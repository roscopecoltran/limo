...
type GatewayBucket_GithubRepoExtraInfo struct {
	// gorm.Model
	//Repo 			*github.Repository 		  				`yaml:"github_info,omitempty" json:"github_info,omitempty"`			// https://github.com/google/go-github/blob/master/github/repos.go#L22-L117
	UserInfo      *github.User        `yaml:"user_info,omitempty" json:"user_info,omitempty"` //
	Readme        string              `yaml:"readme,omitempty" json:"readme,omitempty"`       // https://github.com/google/go-github/blob/master/github/repos_contents.go#L22-L38
	Files         map[string][]string `yaml:"files,omitempty" json:"files,omitempty"`         //
	Trees         []*github.Tree      `yaml:"trees,omitempty" json:"trees,omitempty"`         //
	Languages     map[string]int      `yaml:"language,omitempty" json:"language,omitempty"`   //
	Branches      []string            `yaml:"branch_list,omitempty" json:"branch_list,omitempty"`
	Releases      []string            `yaml:"releases,omitempty" json:"releases,omitempty"`
	ReleaseLatest string              `yaml:"latest_release,omitempty" json:"latest_release,omitempty"`
	Stargazers    []string            `yaml:"stargazers,omitempty" json:"stargazers,omitempty"`
	//WatchersList  []string 								`yaml:"watchers,omitempty" json:"watchers,omitempty"`
	//LanguageDetection 	map[string]int 					`yaml:"language_detected,omitempty" json:"language_detected,omitempty"`
}
