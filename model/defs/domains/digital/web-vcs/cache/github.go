...
// https://github.com/nmiyake/ghcli
// https://github.com/jgautheron/exago/blob/master/github/cache.go
// https://github.com/jgautheron/exago/blob/master/github/github.go
...
func NewCache_Github(client *github.Client) Cache_Github {
	return &cache{
		client: client,
...
type cache_Github struct {
	client *github.Client
	cache  map[string]string
}

func (c *cache_Github) Get(licenseKey string) (string, error) {
